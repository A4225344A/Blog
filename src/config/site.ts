export const siteConfig = {
  author: { name: 'Jacky（謝宇逸）', githubUrl: 'https://github.com/A4225344A', avatar: 'images/avatar.png', tagline: { 'zh-TW': '全端工程師，正在走向雲原生', en: 'Full-stack engineer moving toward cloud native' } },
