...
const en = {
  ...
  latestNote: 'Listed by original publication date. For a guided reading order, follow the article series below.',
...
const zh: typeof en = {
  ...
  heroTitle: '從一個部落格，記下工程選擇', heroLabel: '全端開發與工程實作', projectLabel: '專案實驗室',
  latestNote: '依原始發布日期排列；循序閱讀請使用下方文章系列。',
