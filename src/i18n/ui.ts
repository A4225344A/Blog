...
const en = {
  ...
  beginnerIntro: 'Start here if you do not know where to type commands. The Windows guide explains each tool and helps you build your own website from an empty folder.',
...
const zh: typeof en = {
  ...
  beginnerIntro: '不知道指令要輸入在哪裡也沒關係。Windows 入門教學會解釋工具用途，帶你從空資料夾建立自己的網站。',
