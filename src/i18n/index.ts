...
export const messages = {
  'zh-TW': { title: '全端工程師的技術部落格', tagline: '記錄個人專案、全端實作與架構取捨。',
    pending: '內容準備中。', skip: '跳至主要內容', language: '語言', theme: '外觀', light: '淺色', dark: '深色', system: '跟隨系統', home: '首頁' },
  en: { title: 'A Full-Stack Engineer’s Blog', tagline: 'Personal projects, full-stack implementation and architecture decisions.',
